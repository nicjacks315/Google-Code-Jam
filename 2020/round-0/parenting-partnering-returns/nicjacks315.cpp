...
//  8) Almost blew with the pre-emptive sorting - results expect activites to be assigned based in the order of their input, not chronologically! Tracked activity number with x; another advantage of using the heavier struct instead of int vectors
